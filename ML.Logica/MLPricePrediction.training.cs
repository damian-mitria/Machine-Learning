...
namespace ML_Logica
{
    public partial class MLPricePrediction
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=32768,MinimumExampleCountPerLeaf=128,NumberOfIterations=3488,MaximumBinCountPerFeature=18,LearningRate=1.20131821485374E-06F,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.1F,FeatureFraction=1F,L1Regularization=2E-10F,L2Regularization=0.000126410326738111F}}));
